      ...
      @include('header')
          ...
          <div class="site-content">
            ...
            <div class="howiwanna">
              ...
              <div class="howiwanna-sentence">
                前職では５年、10年保存期間が定められている文書の多くが倉庫に紙で眠っていました。正直、探し出すのにも時間がかかり、効率が悪いと感じました。
              </div>   
              <div class="howiwanna-sentence">
                また、世の中がインターネットやIT技術などによって目まぐるしい成長を遂げている中、ギャップを感じ、自分自身社会の成長速度に合わせて知識を身につけつつ、世の中に貢献したいと思いました。
              </div>  
              <div class="howiwanna-sentence">
                そのような環境に身を置きたく、未経験からでもエンジニアを目指すことができるテックキャンプに入校しました。学習の過程で、多くのエラーを解決しながら、思いを形に近づけていく過程に楽しさとやりがいを感じました。また、プログラミングに触れることで世の中の見え方が変わり、もっとIT業界を知りたい、より多くの方と共通の目標を目指したい、と心から思いそこで決意を固めました。<br>
              </div>  
            </div>
          </div>
